...
export const articleCardClass =
  "bg-[#f5f5f7] p-7 hover:bg-[#ebebf0] transition-colors duration-200 flex flex-col gap-2.5 cursor-pointer rounded-2xl w-full min-w-0 overflow-hidden";
export const articleTitle = "text-base font-semibold text-[#1d1d1f] leading-snug tracking-tight break-all";
export const articleExcerpt = "text-sm text-[#6e6e73] leading-relaxed break-all";
